...
<tr height="73">
	...
	<td width="320" valign="top" background="images/6.png" rowspan="2" style="background-color: #ffffff;background-repeat: no-repeat;background-position: right bottom;">
		...
		<input type="text" class="niceform" id="companycode" name="companycode" style="ime-mode:disabled; font-size:14px;font-variant: small-caps" value="BIOS"/>&nbsp;&nbsp;<a href="<%=path %>/help/help_error.jsp" title="什么是公司编码" target="_blank"><img src="images/whycompany.gif" border="0"/></a></td>
		</tr>
		<tr>
